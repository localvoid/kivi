 ...
 */
VNode.text = function(content, key) {
 ...
 */
VNode.element = function(tag, key) {
  if (key === void 0) key = null;
 ...
 * @return {VNode} Element VNode.
 */
VNode.component = function(descriptor, data, key) {
  if (key === void 0) key = null;
 ...
 */
VNode.create = function(node, context) {
  ...
  if ((flags & V_TEXT) !== 0) {
    ...
    var component = Component.create(node.tag, node.data, context);
 ...
 * @param {Context} context
 */
VNode.render = function(node, context) {
  var i, il;
  var key;
  var flags = node.flags;
  ...
  if ((flags & (V_ELEMENT | V_COMPONENT | V_ROOT)) !== 0) {
    ...
    if ((flags & V_COMPONENT) !== 0) {
      ...
      var cFlags = component.flags;
      if ((cFlags & C_INIT_HOOK) !== 0) {
        descriptor.init.call(component);
      }
      component.update();
      if ((cFlags & C_RENDERED_HOOK) !== 0) {
 ...
 * @param {Context} context
 */
var update = VNode.update = function(a, b, context) {
  var ref = a.ref;
  var flags = a.flags;
  b.ref = ref;
  ...
  if ((flags & V_TEXT) !== 0) {
    ...
    if ((flags & V_COMPONENT) !== 0) {
      ...
      if (component.updateProps(b.data)) {
...
function insertChild(parent, node, nextRef, context) {
  if (((parent.flags & V_COMPONENT) === 0) ||
    ...
    VNode.create(node, context);
    parent.ref.insertBefore(node.ref, nextRef);
    VNode.render(node, context);
  } else {
...
/**
 * Component flag: Component is dirty and should be updated.
 * @const
 * @type {number}
 */
var C_DIRTY = 1;
...
/**
 * Component flag: Component is stateless.
 * @const
 * @type {number}
 */
var C_STATEFUL = 2;
...
/**
 * Component flag: Component is attached to the Document.
 * @const
 * @type {number}
 */
...
/**
 * Component Descriptor flag: Component has `updateProps` function.
 * @const
 * @type {number}
 */
 ...
 * @return {!Object}
 */
Component.declare = function(spec) {
  var flags = 0|0;
  var tag = spec.tag;
...
Component.create = function(descriptor, props, ctx) {
...
Component.prototype.updateProps = function(props) {
  if ((this.flags & C_UPDATE_PROPS_HOOK) !== 0) {
    return this.descriptor.updateProps.call(this, props);
  } else {
...
Component.prototype.updateView = function(newRoot) {
  ...
  if (root == null) {
    ...
    newRoot.cref = this;
    VNode.render(newRoot, this);
  } else {
    VNode.update(root, newRoot, this);
  }
  this.root = newRoot;
};
