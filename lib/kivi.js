...
function invalidate(component) {
  if (component.flags & COMPONENT_DIRTY === 0) {
    ...
    scheduler.nextFrame().write(component.depth, component._update);
  }
}

function updateComponentLater(component) {
  if (component.flags & (COMPONENT_DOM_ATTACHED | COMPONENT_DIRTY) ===
      (COMPONENT_DOM_ATTACHED | COMPONENT_DIRTY)) {
    updateComponent(component);
  }
}
